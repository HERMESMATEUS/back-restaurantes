  ...
  userBlocked() {
    ...
    return (
      ...
      <View style={{ flexDirection: 'row', width: '100%', height: 60, marginVertical: 10, paddingHorizontal: 20 }}>
        ...
        <TouchableOpacity onPress={() => CallBackNavigateChatUser()} style={{ flexDirection: 'row', width: '100%', height: 60, marginVertical: 10, justifyContent: 'center', alignItems: 'center' }} >
